...
\externaldocument[sp-]{supplementary}
...
Hence, the pairwise distance matrix is estimated in a time that increases log-linearly in the length of sequences, and in our implementation can scale sub-quadratically with the number of isolates (see SI sect.\ref{sp-sec:pangraph-algo} for details).
...
More details on the merging procedure and the effect of parameters can be found in SI section I.
