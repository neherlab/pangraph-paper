...
\begin{figure*}[htb]
    ...
    \caption{{\bf Benchmark on real data}.
        ...
        \textbf{C}: sequence compression, defined as the ratio between the pangenome graph size and the cumulative size of all the sequences contained in the graph. For reference, the inverse of this number is marked.
    }
