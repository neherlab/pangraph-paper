...
Upon completion, transitive edges within the graph, i.e., edges along which all path are co-linear, are removed by merging adjacent \emph{pancontigs}. \oldnew{}{More details on the merging procedure and the effect of parameters can be found in SI section I.}
