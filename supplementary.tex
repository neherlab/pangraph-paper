...
We downloaded from RefSeq \cite{o2016reference} complete chromosomes from 5 different bacterial species, listed in Table~\ref{table:panx-dataset}.\footnote{A complete list of accession numbers can be found in...}. These genomes had previously been analyzed with PanX \cite{ding2018panx}. For each species we also report the average genome lenght and average pairwise divergence on core genome.
...
\begin{table}[hb]
    \begin{tabular}{l l l l}
        ...
        \hline
        E.~Coli         & 307         & 4.98                         &                                       \\
        K.~Pneumoniae   & 109         & 5.35                         &                                       \\
        H.~Pylori       & 85          & 1.62                         &                                       \\
        M.~Tuberculosis & 51          & 4.40                         &                                       \\
        P.~Marinus      & 10          & 1.80                         &                                       \\
        \hline
    \end{tabular}
...
\end{itemize}
% TODO: describe expectations and reasons for the choice
