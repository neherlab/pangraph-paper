...
\Marco{Make more to the point. Data are from PanX (archived run May 2018, not the version used in the paper). Add the date. First point at the reason: core genome and not soft core. Similar problems in other pipelines. Also other, but not dramatic. Give numbers}
