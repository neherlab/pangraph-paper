...
\responsedraft{
      We appreciate the reviewer's remarks and apologize fot our summary discussion of the literature. To this end we modified the introduction with a more in-depth analysis of the existing methods, and how pangraph compares to them.\\
      We modified the introduction adding citations to more methods that use pangenome graphs for either improvement of annotations...
      % SURVEY OF THE LITERATURE
      % PGG have been used to:
      % - improve annotations [sutton + ggcaller]
