...
% - no alignment "line"
% - [x] csv file 
% - [ ] supplementary: move graph structure to new section and add two figures from the docs.
% - [x] R1.1
% - [x] R1.5
% - [ ] R1.8
% - [ ] R2.2
% - [x] R2.6
% - [x] R2.9
% - [x] remove \oldnew and use git diff
% pangraph automatic testing -> sequence reconstruction
